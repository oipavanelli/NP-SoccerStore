...
<div class="product">
    <div class="product-images">
        <img src="img/1bd4a1b1.jpg" alt="Imagem 1">
        <img src="img/V2.jpg" alt="Imagem 2">
        <img src="img/V3.jpg" alt="Imagem 3">
        <img src="img/V4.jpg" alt="Imagem 4">
        <img src="img/V1.jpg" alt="Imagem 5">
    </div>

    <div class="product-thumbnails">
        <img src="img/1bd4a1b1.jpg" alt="Thumbnail 1">
        <img src="img/V2.jpg" alt="Thumbnail 2">
        <img src="img/V3.jpg" alt="Thumbnail 3">
        <img src="img/V4.jpg" alt="Thumbnail 4">
        <img src="img/V1.jpg" alt="Thumbnail 5">
    </div>
</div>
    
    <div class="product-description" style="margin-top:-527px; margin-left:770px;">
        <h2>Camisa Vasco da Gama<br>Edição Especial 21-22</h2>
        <h4>R$ 169,90</h4>
