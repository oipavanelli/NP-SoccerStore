...
<header class="center">
    ...
    <div class="product-images">
        <img src="img/409722d2.jpg" alt="Imagem 1">
        <img src="img/SCI1.jpg" alt="Imagem 2">
        <img src="img/SCI2.jpg" alt="Imagem 3">
        <img src="img/SCI4.jpg" alt="Imagem 4">
        <img src="img/SCI3.jpg" alt="Imagem 5">
    </div>

    <div class="product-thumbnails">
        <img src="img/409722d2.jpg" alt="Thumbnail 1">
        <img src="img/SCI1.jpg" alt="Thumbnail 2">
        <img src="img/SCI2.jpg" alt="Thumbnail 3">
        <img src="img/SCI4.jpg" alt="Thumbnail 4">
        <img src="img/SCI3.jpg" alt="Thumbnail 5">
    </div>
</div>
    
    <div class="product-description" style="margin-top:-527px; margin-left:770px;">
        <h2>Camisa Internacional<br>Edição III 22-23</h2>
        <h4>R$ 169,90</h4>
