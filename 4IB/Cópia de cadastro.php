...
<body>
	<img src="n.png" alt="Imagem de login" width="500px" style="float: left; margin-top:125px ; margin-right: 20px;">
		...
		<div id="cadastro-tab" class="tab">
			<div class="tab-content">				
				<form method="POST" action="gravar.php">
					...
					<br>
					<label for="confirmar-senha">CPF</label>
					<input type="text" id="cpf" name="cpf" required>
					<br>
					<label for="email">Email</label>
					<input type="text" id="email" name="email" required>
					<br>
					<label for="confirmar-email">Confirme o Email</label>
					<input type="text" id="confirmar-email" name="confirmar-email" required>
					<br>
	...
	<div class="bai">
		<form method="POST" action="cadastroad.php">
			<input type="submit" id="create-admin-button" class="create-admin-button" onclick="createAdmin()" value="Criar Admin">
		</form>
	</div>
</body>
</html>