...
$query = "SELECT id, nomeprod, descricao, valor, imagem FROM tb_produtos WHERE codigo = 6 ";
...
.report-button:hover {
    ...
    <title>Página de Produtos - Calções</title>
    <script>
...
<header>
    ...
    <div class="dropdown">
            <a href="cad-localizar.php">Localizar Usuários</a>
        </div>
    
        <div class="dropdown">
            <a href="prod-cadastro.php">Cadastrar Produto</a>
        </div>
