...
$query = "SELECT id, usuario, cpf, email, status FROM tb_comprador";
...
<html>
<head>
    <title>Relatório de Usuarios</title>
</head>
<style> 
body {
...
<div class="header2">
    ...
    <button class="report-button" onclick="window.location.href = 'relatorio-camisas.php'">Relatório de Camisas</button>
   ...
   <br><br><br> <!--<button class="report-button" onclick="window.location.href = 'relatorio-produtos.php'">Relatório de Produtos</button>-->
</body>
</html>
