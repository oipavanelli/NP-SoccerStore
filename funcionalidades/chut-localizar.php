...
$query = "SELECT id, nomeprod, descricao, valor, imagem FROM tb_produtos WHERE codigo = 3";
...
<head>
    ...
    <title>Página de Produtos - Chuteiras</title>
    <script>
...
?>
    ...
    <!--<button class="report-button" onclick="window.location.href = 'bola-localizar.php'">Bolas</button>
    <button class="report-button" onclick="window.location.href = 'luvas-localizar.php'">Luvas</button>
    <button class="report-button" onclick="window.location.href = 'prod-localizar.php'">Camisas</button>
    <button class="report-button" onclick="window.location.href = 'conj-localizar.php'">Conjuntos</button>
    <button class="report-button" onclick="window.location.href = 'calc-localizar.php'">Calção</button>
    <button class="report-button" onclick="window.location.href = 'cane-localizar.php'">Caneleiras</button>
    <button class="report-button" onclick="window.location.href = 'garr-localizar.php'">Garrafas</button>-->
</html>
<?php
