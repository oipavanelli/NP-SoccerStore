        ...
        <div id="login-tab" class="tab active">
            <div class="tab-content2">
                <div class="tab-content">                
                    <form method="POST" action="adm-gravar.php">
                        <h2>
							<div class="tlogin">
								<label> Tela de ADMINSTRADOR </label>
							</div>
						</h2>
						<br>
						...
						<input type="submit" class="entrar-button" value="Cadastrar Admin">
                    </form>
                </div>
            </div>
        </div>
       
        <p class="menu-text">Essa página será única, após criar o Administrador, o botão será retirado.</div>

    <?php
    // Se houver um erro definido, exiba-o na página
    if (isset($erro)) {
        echo '<p>' . $erro . '</p>';
    }
    ?>
