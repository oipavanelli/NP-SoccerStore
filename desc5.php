...
<div class="product">
    <div class="product-images">
        <img src="img/d1.jpeg" alt="Imagem 1">
        <img src="img/CEC1.jpg" alt="Imagem 2">
        <img src="img/CEC2.jpg" alt="Imagem 3">
        <img src="img/CEC3.jpg" alt="Imagem 4">
        <img src="img/CEC4.jpg" alt="Imagem 5">
    </div>

    <div class="product-thumbnails">
        <img src="img/d1.jpeg" alt="Thumbnail 1">
        <img src="img/CEC1.jpg" alt="Thumbnail 2">
        <img src="img/CEC2.jpg" alt="Thumbnail 3">
        <img src="img/CEC3.jpg" alt="Thumbnail 4">
        <img src="img/CEC4.jpg" alt="Thumbnail 5">
    </div>
</div>
    
    <div class="product-description" style="margin-top:-527px; margin-left:770px;">
        <h2>Camisa Cruzeiro<br>Edição II 22-23</h2>
        <h4>R$ 169,90</h4>
